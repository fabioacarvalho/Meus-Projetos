<template>
    ...
    <header id="header">
        ...
        <nav id="nav">
            <!-- Menu Haburguer -->
            <button @click="toggleMenu" @touchstart="toggleMenu" id="btn-mobile" aria-label="Abril Menu" aria-haspopup="true" aria-controls="menu">Menu
                <span id="hamburguer" aria-expanded="false"></span>
            </button>
            <ul id="menu" role="menu">
                <li><a href="#" @click="navegarPage">Dados</a></li>
...
export default {
    ...
    methods: {
        ...
        navegarPage() {
            this.telaData = !this.telaData
            console.log(this.telaData)
        }       
    }
}
</script>
